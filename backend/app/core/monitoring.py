...
class PerformanceMonitor:
    ...
    def get_metrics_summary(self, hours: int = 24) -> Dict:
        ...
        summary = {
            ...
            "avg_request_time": sum(m.value for m in request_metrics) / len(request_metrics) if request_metrics else 0,
            "avg_db_query_time": sum(m.value for m in db_metrics) / len(db_metrics) if db_metrics else 0,
            "max_request_time": max(m.value for m in request_metrics) if request_metrics else 0,

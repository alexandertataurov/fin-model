...
from sqlalchemy import Column, Integer, String, Float, DateTime, Text, Boolean, ForeignKey, JSON, Date, BigInteger, UniqueConstraint
...
class Metric(Base):
    ...
    metric_category = Column(String(100), nullable=False, index=True)  # profitability, liquidity, efficiency, etc.
...
class TimeSeries(Base):
    ...
    # Data identification
    data_type = Column(String(100), nullable=False, index=True)  # revenue, expenses, cash_flow, etc.
...
class Calculation(Base):
    ...
    input_parameters = Column(JSON, nullable=False)  # Array of parameter IDs and constants
    output_parameters = Column(JSON, nullable=False)  # Array of parameter IDs this calculation produces
    dependencies = Column(JSON, nullable=True)  # Array of calculation IDs this depends on
...
class DataSource(Base):
    ...
    source_identifier = Column(String(500), nullable=False)  # file ID, API endpoint, etc.

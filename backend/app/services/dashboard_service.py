...
class DashboardService:
    ...
    async def get_user_dashboard_data(
        ...
        try:
            ...
            chart_data = (
                await self.enhanced_charts.generate_enhanced_dashboard_charts(
    ...
    async def _generate_dashboard_charts(
        ...
        if pl_statements:
            ...
            charts[
                "expense_breakdown"
            ] = await self._generate_expense_breakdown_chart(pl_statements[0])
        ...
        if bs_statements:
            charts[
                "asset_composition"
            ] = await self._generate_asset_composition_chart(bs_statements[0])
    ...
    async def _generate_expense_breakdown_chart(
        ...
        expense_categories = [
            ...
            (
                "Operating Expenses",
                ["operating_expenses", "opex", "selling_admin"],
            ),
    ...
    async def _generate_pl_charts(
        ...
        charts["profit_margins"] = await self._generate_profit_margins_chart(
            statement
        )
        ...
        return {
            "assets": {
                ...
                "fixed_assets": self._extract_metric_value(
                    line_items,
                    ["fixed_assets", "non_current_assets", "ppe"],
                ),

...
class MFAService:
    ...
    def generate_qr_code(user_email: str, secret: str) -> str:
        ...
        provisioning_uri = totp.provisioning_uri(
            user_email, issuer_name=settings.WEBAUTHN_RP_NAME
        )
    ...
    def verify_mfa_token(
        self, user: User, token: str, use_backup: bool = False
    ) -> bool:
        """
    ...
    def create_mfa_challenge(
        self, user: User, challenge_type: str, challenge_data: Dict = None
    ) -> str:
        """

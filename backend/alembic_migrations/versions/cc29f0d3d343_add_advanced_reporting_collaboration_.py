...
def upgrade() -> None:
    ...
    if not any(
        idx["name"] == "ix_report_templates_created_by"
    ...
    if table_exists("report_collaborations") and not any(
        idx["name"] == "ix_report_collaborations_template_id"
    ...
    if table_exists("report_collaborations") and not any(
        idx["name"] == "ix_report_collaborations_user_id"
        for idx in inspector.get_indexes("report_collaborations")
    ):
        op.create_index(
    ...
    if table_exists("report_edits") and not any(
        idx["name"] == "ix_report_edits_template_id"
    ...
    if table_exists("collaboration_sessions") and not any(
        ...
        for idx in inspector.get_indexes("collaboration_sessions")
    ):
        op.create_index(

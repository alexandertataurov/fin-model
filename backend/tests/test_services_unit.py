...
class TestParameterDetector:
    ...
    def test_validate_assumptions(self):
        ...
        detector = ParameterDetector()
        assumptions = {"growth_rate": 0.15, "discount_rate": 0.10, "tax_rate": 0.25}
...
class TestScenarioManager:
    ...
    def test_monte_carlo_simulation(self):
        ...
        simulation_result = manager.monte_carlo_simulation(
            parameter_distributions, iterations=100
        )
    ...
    def test_scenario_comparison(self):
        ...
        scenario1 = {"name": "Scenario A", "results": {"npv": 1000000, "irr": 0.15}}

        scenario2 = {"name": "Scenario B", "results": {"npv": 1200000, "irr": 0.18}}

        with patch.object(
            manager, "compare_scenarios", return_value=[scenario1, scenario2]
        ) as mock_compare:
            comparison = manager.compare_scenarios(
                compare_scenario_id=1, user_id=1, base_scenario_id=1
            )
...
class TestServiceIntegration:
    ...
    def test_parameter_to_scenario_pipeline(self):
        ...
        assumptions = {"growth_rate": 0.12, "discount_rate": 0.09, "tax_rate": 0.28}

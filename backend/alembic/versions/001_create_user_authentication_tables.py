...
def upgrade() -> None:
    ...
    op.create_table('roles',
        ...
        sa.Column('name', sa.Enum('ADMIN', 'ANALYST', 'VIEWER', name='roletype'), nullable=False),
    ...
    op.create_table('audit_logs',
        ...
        sa.Column('action', sa.Enum('LOGIN', 'LOGOUT', 'REGISTER', 'PASSWORD_CHANGE', 'PASSWORD_RESET', 'EMAIL_VERIFICATION', 'ROLE_ASSIGNED', 'ROLE_REMOVED', 'ACCOUNT_LOCKED', 'ACCOUNT_UNLOCKED', 'PROFILE_UPDATED', 'FAILED_LOGIN', 'PERMISSION_DENIED', name='auditaction'), nullable=False),

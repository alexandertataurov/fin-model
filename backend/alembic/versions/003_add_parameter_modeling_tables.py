...
def upgrade():
    ...
    op.create_index(op.f('ix_parameters_category'), 'parameters', ['category'], unique=False)
    ...
    op.create_index(op.f('ix_parameters_parameter_type'), 'parameters', ['parameter_type'], unique=False)
    ...
    op.create_table('scenarios',
        ...
        sa.Column('updated_at', sa.DateTime(), nullable=True),
        sa.Column('created_by_id', sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(['base_file_id'], ['uploaded_files.id'], ),
        sa.ForeignKeyConstraint(['created_by_id'], ['users.id'], ),
    ...
    op.create_table('sensitivity_analyses',
        ...
        sa.ForeignKeyConstraint(['created_by_id'], ['users.id'], ),
        sa.ForeignKeyConstraint(['scenario_id'], ['scenarios.id'], ),
        sa.ForeignKeyConstraint(['target_parameter_id'], ['parameters.id'], ),
        sa.PrimaryKeyConstraint('id')
    )

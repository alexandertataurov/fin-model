...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "period_type",
            sa.Enum("MONTHLY", "QUARTERLY", "YEARLY", "CUSTOM", name="periodtype"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "metric_category", sa.String(length=100), nullable=False
        ),  # profitability, liquidity, efficiency, etc.
        sa.Column(
            "metric_type",
            sa.Enum(
                "RATIO", "PERCENTAGE", "CURRENCY", "COUNT", "DAYS", name="metrictype"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_metrics_period", "metrics", ["period_start", "period_end"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column("scenario_id", sa.Integer(), nullable=False),
        sa.Column(
            "data_type", sa.String(length=100), nullable=False
        ),  # revenue, expenses, cash_flow, etc.
        sa.Column(
            "data_subtype", sa.String(length=100), nullable=True
        ...
        sa.Column(
            "frequency",
            sa.Enum(
                "DAILY", "WEEKLY", "MONTHLY", "QUARTERLY", "YEARLY", name="frequency"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_time_series_scenario", "time_series", ["scenario_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "input_parameters", sa.JSON(), nullable=False
        ),  # Array of parameter IDs and constants
        sa.Column(
            "output_parameters", sa.JSON(), nullable=False
    ...
    op.create_index(
        "ix_calculations_scenario", "calculations", ["scenario_id"], unique=False
    )
    op.create_index(
        "ix_calculations_order", "calculations", ["execution_order"], unique=False
    )
    op.create_index(
        "ix_calculations_name", "calculations", ["calculation_name"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "template_type",
            sa.Enum("EXCEL", "CSV", "JSON", "CUSTOM", name="templatetype"),
            nullable=False,
        ),
        sa.Column(
            "file_structure", sa.JSON(), nullable=False
        ),  # Defines expected file structure
        sa.Column(
            "mapping_rules", sa.JSON(), nullable=False
    ...
    op.create_table(
        ...
        sa.Column(
            "change_type",
            sa.Enum(
                "INITIAL", "UPDATE", "CORRECTION", "REPROCESSING", name="changetype"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_file_versions_current", "file_versions", ["is_current"], unique=False
    )
    op.create_index(
        "ix_file_versions_hash", "file_versions", ["file_hash"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "source_identifier", sa.String(length=500), nullable=False
    ...
    op.create_index(
        "ix_data_sources_type", "data_sources", ["source_type"], unique=False
    )
    op.create_index(
        "ix_data_sources_name", "data_sources", ["source_name"], unique=False
    )

    # Add relationships to existing tables by adding new columns
    op.add_column(
        "uploaded_files", sa.Column("template_id", sa.Integer(), nullable=True)
    )
    op.add_column(
        "uploaded_files", sa.Column("data_source_id", sa.Integer(), nullable=True)
    )
    op.create_foreign_key(
        "fk_uploaded_files_template",
        "uploaded_files",
        "templates",
        ["template_id"],
        ["id"],
    ...
    op.add_column(
        "parameters", sa.Column("data_source_id", sa.Integer(), nullable=True)
    )
    op.create_foreign_key(
        "fk_parameters_data_source",
        "parameters",
        "data_sources",
        ["data_source_id"],
        ["id"],
...
def downgrade():
    ...
    op.drop_constraint(
        "fk_uploaded_files_data_source", "uploaded_files", type_="foreignkey"
    )
    op.drop_constraint(
        "fk_uploaded_files_template", "uploaded_files", type_="foreignkey"
    )

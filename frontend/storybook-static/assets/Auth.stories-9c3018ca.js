        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">\r
          <div>\r
            ...
            <ul className="space-y-1 text-sm text-muted-foreground">\r
              <li>• Email/password authentication</li>\r
              <li>• Biometric authentication</li>\r
              <li>• Single Sign-On (SSO)</li>\r
              <li>• Two-factor authentication (2FA)</li>\r
            </ul>\r
          </div>\r
          <div>\r
            <h4 className="font-medium mb-2">Security Features</h4>\r
            <ul className="space-y-1 text-sm text-muted-foreground">\r
              <li>• Password strength validation</li>\r
              <li>• Account lockout protection</li>\r
              <li>• Session timeout management</li>\r
              <li>• Audit logging and monitoring</li>\r
            </ul>\r
          </div>\r
        </div>\r
      </div>\r
...
}`,...h.parameters?.docs?.source}}};const _=["AuthenticationOverview","LoginForm","RegisterForm","ForgotPasswordStory","ResetPasswordStory","EmailVerificationStory","AuthStates"];export{h as AuthStates,c as AuthenticationOverview,x as EmailVerificationStory,p as ForgotPasswordStory,n as LoginForm,m as RegisterForm,u as ResetPasswordStory,_ as __namedExportsOrder,Y as default};

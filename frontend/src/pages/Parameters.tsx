...
const Parameters: React.FC = () => {
  ...
  const parameterCategories = [
    ...
    },
    {
      ...
      description:
        'Corporate tax rates, state taxes, tax credits, foreign taxes',
    },
    {
      id: 'revenue',
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Configure comprehensive financial modeling parameters across 12
            categories
          </p>
        </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div className="space-y-2">
                      <Label htmlFor={`${category.id}-param1`}>
                        Parameter 1
                      </Label>
                      <Input
                    ...
                    <div className="space-y-2">
                      <Label htmlFor={`${category.id}-param2`}>
                        Parameter 2
                      </Label>
                      <Input
                    ...
                    <div className="space-y-2">
                      <Label htmlFor={`${category.id}-param3`}>
                        Parameter 3
                      </Label>
                      <Input

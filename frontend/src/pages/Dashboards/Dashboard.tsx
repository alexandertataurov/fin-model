...
const Dashboard = () => {
  ...
  const { data: ratiosData } = useFinancialRatios(
    selectedPeriod as unknown as DashboardPeriod
  );

  // Load dashboard data
  const loadDashboardData = useCallback(
    async (period: PeriodFilter = selectedPeriod, isRefresh = false) => {
      try {
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 py-4 sm:py-6">
          <div className="flex-1 min-w-0">
            ...
            <Caption className="text-muted-foreground mt-1 sm:mt-2">
              {dashboardData &&
              (dashboardData as any).data_quality_score !== undefined
      ...
      <main>
        ...
        <section className="py-6">
          <div className={componentStyles.container}>
            <Heading2 className="mb-4">Key Financial Metrics</Heading2>
                          ...
                          >
                            ...
                            <CardContent>
                              ...
                              {metric.change_percentage !== undefined && (
                                ...
                                >
                                  {metric.change_percentage > 0 ? '+' : ''}
                                  {metric.change_percentage.toFixed(1)}% from
                                  last period
                                </Caption>
                              )}
                            </CardContent>
        ...
        <section className="py-6 border-t">
          <div className={componentStyles.container}>
            <div className="flex items-center justify-between mb-4">
              <Heading2>Recent Financial Statements</Heading2>
              <Button
                variant="outline"
                size="sm"
                ...
                <div className="col-span-full">
                  <Card>
                    <CardContent className="text-center py-8">
                      <BodyText className="text-muted-foreground mb-4">
                        No financial statements uploaded yet. Upload your first
        ...
        <section className="py-6 border-t">
          <div className={componentStyles.container}>
            <Heading2 className="mb-4">Financial Modeling Workspace</Heading2>

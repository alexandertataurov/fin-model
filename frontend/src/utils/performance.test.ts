...
describe('Performance Tests', () => {
  describe('Component Rendering Performance', () => {
    ...
    it('should render charts efficiently with large datasets', () => {
      ...
      console.log(`Chart render time (1000 points): ${renderTime.toFixed(2)}ms`);
    });
  ...
  describe('Data Processing Performance', () => {
    it('should process large datasets efficiently', () => {
      ...
      console.log(`Data processing time (10k items): ${processingTime.toFixed(2)}ms`);
    });
  ...
  describe('Accessibility Performance', () => {
    it('should maintain performance with accessibility features', () => {
      ...
      console.log(`Accessible component render time: ${renderTime.toFixed(2)}ms`);
    });
  });
});

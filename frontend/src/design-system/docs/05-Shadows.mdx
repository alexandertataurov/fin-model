...
parameters:
  docs:
    description:
      component: 'Our shadow system provides consistent elevation levels and visual feedback that create depth, hierarchy, and interactive states across all components.'
    canvas:
      sourceState: 'hidden'
---
...
<Meta
  title="* - Documentation/Foundations/Shadows"
  parameters={{
    viewMode: 'docs',
    previewTabs: {
      canvas: { hidden: true },

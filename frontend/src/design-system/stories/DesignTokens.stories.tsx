...
### Usage
Import tokens from \`../tokens.json\` to maintain consistency across components.
        `,
            },
        },
    },
                ...
                <CardContent>
                    <div className="space-y-4">
                        <div>
                            ...
                            <p className="text-lg" style={{ fontFamily: tokens.typography.fontFamily.sans.join(', ') }}>
                        ...
                        <div>
                            ...
                            <p className="text-lg" style={{ fontFamily: tokens.typography.fontFamily.mono.join(', ') }}>
                                The quick brown fox jumps over the lazy dog
                            </p>
                            <p className="text-sm text-muted-foreground mt-1">
                ...
                <div className="space-y-4">
                    {Object.entries(tokens.spacing).map(([key, value]) => (
                        <div key={key} className="flex items-center space-x-4">
                            ...
                            <div className="w-16 text-sm font-mono text-muted-foreground">{value}</div>
                            <div
                    ...
                    {Object.entries(tokens.zIndex).map(([key, value]) => (
                        <div key={key} className="flex items-center justify-between p-3 bg-muted rounded">
                            ...
                            <div className="text-xs px-2 py-1 bg-accent-100 text-accent-700 rounded">
                                ...
                                {key === 'auto' && 'Auto'}
                                {!['dropdown', 'sticky', 'fixed', 'modal', 'popover', 'tooltip', 'auto'].includes(key) && 'Custom'}
                            </div>
                        </div>
                    ))}
                </div>

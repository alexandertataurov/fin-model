...
const BorderDemo = ({
  ...
  <div className="p-6 rounded-xl border bg-card space-y-4">
    ...
    <div
      className={`h-16 bg-background ${borderClass} flex items-center justify-center text-xs text-foreground`}
    >
      Border Example
    </div>
    <div className="text-xs text-muted-foreground font-mono">{borderClass}</div>
  </div>
);
...
const BorderRadiusDemo = ({
  ...
  <div className="p-6 rounded-xl border bg-card space-y-4">
    ...
    <div className="text-xs text-muted-foreground">{description}</div>
    <div
      className={`h-16 bg-primary/10 ${radiusClass} flex items-center justify-center text-xs text-primary`}
    >
      Radius Example
    </div>
    ...
    <div className="space-y-16">
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <BorderDemo
            name="Mixed Widths"
            borderClass="border-t-2 border-r-4 border-b border-l-8 border-gray-300"

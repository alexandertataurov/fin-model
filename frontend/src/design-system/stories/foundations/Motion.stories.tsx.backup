...
const EasingDemo = ({ easing, name }: { easing: string; name: string }) => {
  ...
  return (
    <Card className="p-6">
      ...
      <div
        className="text-xs font-mono mt-3 break-words"
        style={{
        ...
        <div className="space-y-6">
          ...
          <Card className="p-6">
            ...
            <div className="flex gap-2">
              ...
              >
                transition: all {tokens.motion.duration.slow}{' '}
                {tokens.motion.easing['ease-in-out']}
              </code>
            </div>
          </Card>
          ...
          <Card className="p-6">
            ...
            >
              ...
              easing for playful, attention-grabbing animations.
            </p>
            <div className="flex gap-2">
              <span
                className="text-sm"
              ...
              <code
                className="text-sm bg-primary/10 px-2 py-1 rounded overflow-x-auto"
                style={{
                  fontSize: tokens.typography.fontSize.sm,
                  background: `${tokens.colors.primary[500]}1A`,
                  padding: `${tokens.spacing[1]} ${tokens.spacing[2]}`,
    ...
    <div className="space-y-16">
      <div>
        ...
        <Card className="p-6">
                  ...
                  transitionDelay:
                    tokens.motion.delay[
                      ['none', 'fast', 'normal', 'slow'][
                        index
                      ] as keyof typeof tokens.motion.delay
                    ],
                  transitionDuration: tokens.motion.duration.slow,
                }}
                onMouseEnter={e => {
                  e.currentTarget.style.transform =
                    'translateY(-8px) scale(1.1) rotate(3deg)';
          ...
          >
            <p>
              Hover over each card to see elastic easing with staggered delays:
            </p>
            <ul
      ...
      <div>
        ...
        <div className="space-y-6">
          <Card className="p-6">
            ...
            <ul className="space-y-1" style={{ gap: tokens.spacing[1] }}>
              <li
                className="text-sm"
                style={{
                  fontSize: tokens.typography.fontSize.sm,

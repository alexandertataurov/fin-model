    ...
    <div className="space-y-16">
      ...
      <div className="space-y-8">
        <div className="text-center">
          <h4 style={applyTextStyle('title')} className="text-gray-900 mb-4">
            Buttons
          </h4>
          <p style={applyTextStyle('body')} className="text-gray-600">
            Different button styles with appropriate radius values
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            {
              name: 'Sharp',
              radius: tokens.borderRadius.none,
              description: 'Modern, tech-focused interfaces',
            },
            {
              name: 'Subtle',
              radius: tokens.borderRadius.sm,
              description: 'Professional, understated design',
            },
            {
              name: 'Standard',
              radius: tokens.borderRadius.base,
              description: 'Default button radius',
            },
            {
              name: 'Rounded',
      ...
      <div className="space-y-8">
        <div className="text-center">
          ...
          <p style={applyTextStyle('body')} className="text-gray-600">
            Container elements with different radius values
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            {
              name: 'Sharp Cards',
              radius: tokens.borderRadius.none,
              description: 'Data-heavy interfaces',
            },
            {
              name: 'Subtle Cards',
              radius: tokens.borderRadius.sm,
            ...
            },
            {
              name: 'Standard Cards',
              radius: tokens.borderRadius.base,
              description: 'General content areas',
            },
            {
              name: 'Rounded Cards',
              radius: tokens.borderRadius.lg,
      ...
      <div className="space-y-8">
        <div className="text-center">
          ...
          <p style={applyTextStyle('body')} className="text-gray-600">
            Input fields with appropriate radius values
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            {
              name: 'Sharp Inputs',
              radius: tokens.borderRadius.none,
              description: 'Technical forms',
            },
            {
              name: 'Subtle Inputs',
              radius: tokens.borderRadius.sm,
              description: 'Professional forms',
            },
            {
            ...
            },
            {
              name: 'Rounded Inputs',
              radius: tokens.borderRadius.lg,
              description: 'User-friendly forms',
            },
          ].map(({ name, radius, description }) => (
            <Card key={name} className="p-6">
              <div className="text-sm font-medium text-gray-700 mb-4">
    ...
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {[
          ...
          <Card key={name} className="p-6">
            <h4 className="font-semibold text-gray-900 capitalize mb-4 text-lg">
              {name}
            </h4>
  ...
  render: () => (
    <div className="space-y-12">
      ...
      <div
        ...
        style={{ borderRadius: tokens.borderRadius.xl }}
      >
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 style={applyTextStyle('title')} className="text-gray-900">
                FinVision Analytics
              </h4>
              <p style={applyTextStyle('caption')} className="text-gray-500">
                Portfolio Dashboard
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          {[
            ...
            >
              ...
              <div style={applyTextStyle('title')} className="text-gray-900">
                {value}
              </div>
              <div
                className="text-sm"
                style={{ color: tokens.colors.accent[600] }}
              >
                {change}
              </div>
            </div>
    ...
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <Card className="group p-8 hover:shadow-lg">
          ...
          <p style={applyTextStyle('body')} className="text-gray-600 mb-6">
            Zero radius for modern, tech-focused interfaces. Conveys precision
            and efficiency.
          </p>
        ...
        <Card className="group p-8 hover:shadow-lg">
          ...
          <p style={applyTextStyle('body')} className="text-gray-600 mb-6">
            Minimal radius for professional, understated design. Maintains
            sophistication.
          </p>
          <div className="space-y-2 text-sm">
            <div className="flex justify-between items-center">
        ...
        <Card className="group p-8 hover:shadow-lg">
          ...
          <p style={applyTextStyle('body')} className="text-gray-600 mb-6">
            Comfortable radius for user-friendly interfaces. Creates
            approachable feel.
          </p>
          <div className="space-y-2 text-sm">
            <div className="flex justify-between items-center">
...
export const Documentation: Story = {
  render: () => (
    <div className="space-y-12">
      ...
      {/* Design Philosophy */}
      <Card className="p-8">
        <h4 style={applyTextStyle('title')} className="text-gray-900 mb-6">
          🌟 Design Philosophy
        </h4>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">
                  For data-heavy, technical interfaces
                </div>
              </div>
            </div>
            <div className="flex items-center gap-3">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">
                  User-friendly, approachable feel
                </div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">
                  For avatars, pills, and special elements
                </div>
              </div>
            </div>
          </div>

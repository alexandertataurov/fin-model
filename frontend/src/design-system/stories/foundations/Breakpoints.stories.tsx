...
const meta: Meta = {
  title: '1 - Foundations / Breakpoints',
  tags: ['autodocs'],
  parameters: {
    layout: 'padded',
    docs: {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-6 rounded-xl border bg-card space-y-4">
            ...
            <div className="space-y-3">
              <div className="text-xs font-mono bg-muted/10 p-3 rounded overflow-x-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between p-3 bg-primary/10 border border-primary/20 rounded">
                ...
                <div className="hidden md:flex space-x-2">
                  <div className="text-xs text-primary px-2 py-1 bg-primary/20 rounded">
                    Home
                  </div>
                  <div className="text-xs text-primary px-2 py-1 bg-primary/20 rounded">
                    About
          ...
          <div className="p-6 rounded-xl border bg-card space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
              {Array.from({ length: 6 }, (_, i) => (
                <div
                  key={i}
                  className="bg-accent/10 border border-accent/20 rounded p-2 text-xs text-accent text-center"
                >
                  Card {i + 1}
                </div>
              ))}
          ...
          <div className="p-6 rounded-xl border bg-card space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="text-sm sm:text-base lg:text-lg text-muted-foreground">
                This text adapts to different screen sizes for optimal
                readability.
              </div>
            </div>
            <div className="text-xs text-muted-foreground">
          ...
          <div className="p-6 rounded-xl border bg-card space-y-4">
            ...
            <div className="space-y-2 sm:space-y-4 lg:space-y-6">
              ...
              <div className="bg-secondary/10 border border-secondary/20 rounded p-2 sm:p-4 lg:p-6">
                <div className="text-xs text-secondary">
                  More content with responsive padding
                </div>
              </div>
            </div>
            <div className="text-xs text-muted-foreground">

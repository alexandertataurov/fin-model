...
const meta: Meta = {
  title: '1 - Foundations / Grid System',
  tags: ['autodocs'],
  parameters: {
    layout: 'padded',
    docs: {
...
const FlexSwatch = ({
  ...
  <div className={`p-6 rounded-xl border bg-card space-y-4 ${className}`}>
    <div className="text-sm font-medium text-foreground">{name}</div>
    <div
      className={`flex ${direction} ${justify} ${align} h-24 border border-dashed border-muted rounded`}
    >
    ...
    <div className="space-y-16">
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <GridSwatch name="12-Column Grid" cols="grid-cols-12" gap="gap-2" />
          <GridSwatch name="6-Column Grid" cols="grid-cols-6" gap="gap-3" />
          <GridSwatch name="4-Column Grid" cols="grid-cols-4" gap="gap-4" />
          <GridSwatch name="3-Column Grid" cols="grid-cols-3" gap="gap-4" />
          <GridSwatch name="2-Column Grid" cols="grid-cols-2" gap="gap-6" />
          <GridSwatch name="1-Column Grid" cols="grid-cols-1" gap="gap-4" />
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-6 rounded-xl border bg-card space-y-4">
            ...
            <div className="flex gap-2 h-16">
              <div className="flex-1 bg-primary/10 border border-primary/20 rounded flex items-center justify-center text-xs">
                flex-1
              </div>
              <div className="flex-1 bg-primary/10 border border-primary/20 rounded flex items-center justify-center text-xs">
                flex-1
          ...
          <div className="p-6 rounded-xl border bg-card space-y-4">
            ...
            <div className="flex gap-2 h-16">
              <div className="flex-shrink-0 w-20 bg-accent/10 border border-accent/20 rounded flex items-center justify-center text-xs">
                Fixed
              </div>
              <div className="flex-shrink bg-accent/10 border border-accent/20 rounded flex items-center justify-center text-xs">
                Shrink
              </div>
              <div className="flex-shrink-0 w-20 bg-accent/10 border border-accent/20 rounded flex items-center justify-center text-xs">
                Fixed
  ...
  render: () => (
    <div className="space-y-16">
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <GridSwatch name="Tight Gap" cols="grid-cols-4" gap="gap-1" />
          <GridSwatch name="Small Gap" cols="grid-cols-4" gap="gap-2" />
          <GridSwatch name="Medium Gap" cols="grid-cols-4" gap="gap-4" />
          <GridSwatch name="Large Gap" cols="grid-cols-4" gap="gap-6" />
          <GridSwatch name="Extra Large Gap" cols="grid-cols-4" gap="gap-8" />
          <GridSwatch name="Huge Gap" cols="grid-cols-4" gap="gap-12" />
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="p-6 rounded-xl border bg-card space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2 items-start h-32">
              ...
              <div className="bg-accent/10 border border-accent/20 rounded p-2 text-xs">
                Medium height content
              </div>
              <div className="bg-accent/10 border border-accent/20 rounded p-2 text-xs">
                Very tall content that wraps to multiple lines
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="p-6 rounded-xl border bg-card space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex-1 bg-background border rounded p-3 text-center text-sm">
                Home
              </div>
              <div className="flex-1 bg-background border rounded p-3 text-center text-sm">
                About

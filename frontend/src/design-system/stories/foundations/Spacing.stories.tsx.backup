          ...
          <Card className="p-6">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                {getSpacing('4' as keyof typeof tokens.spacing)}
              </div>
              <div
                className="text-sm"
                style={{ fontSize: tokens.typography.fontSize.sm }}
              >
                ...
                {getSpacing('8' as keyof typeof tokens.spacing)}
              </div>
              <div
                className="text-sm"
                style={{ fontSize: tokens.typography.fontSize.sm }}
              >
                ...
                {getSpacing('16' as keyof typeof tokens.spacing)}
              </div>
            </div>
            <div
              className="mt-4 p-4 bg-muted rounded text-xs font-mono"
            ...
            >
              <code>
                import {`{ getSpacing }`} from '../utils/tokenHelpers'
              </code>
            </div>
          </Card>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                {getSpacing('6' as keyof typeof tokens.spacing)}
              </div>
              <div
                className="text-sm"
                style={{ fontSize: tokens.typography.fontSize.sm }}
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                Prefer spacing tokens over hardcoded values
              </div>
              <div
                className="text-sm"
                style={{ fontSize: tokens.typography.fontSize.sm }}
              >
                ...
                Use responsive spacing for mobile-first design
              </div>
              <div
                className="text-sm"
                style={{ fontSize: tokens.typography.fontSize.sm }}
              ...
              <Card key={size} className="p-6">
                ...
                >
                  <div
                    ...
                    style={{
                      gap: tokens.spacing[size as keyof typeof tokens.spacing],
                    }}
                  >
                    <div
                      className="h-6 rounded"
                          ...
                          : direction === 'py'
                            ...
                            : direction === 'm'
                              ...
                              : direction === 'mx'
                                ...
                                : 'marginTop']:
                        tokens.spacing[
                          selectedSpacing as keyof typeof tokens.spacing
                        ],
                    }}
                  >
                    {direction === 'p' &&
                      `padding: ${tokens.spacing[selectedSpacing as keyof typeof tokens.spacing]}`}
                    {direction === 'px' &&
                      `padding-left/right: ${tokens.spacing[selectedSpacing as keyof typeof tokens.spacing]}`}
                    {direction === 'py' &&
                      `padding-top/bottom: ${tokens.spacing[selectedSpacing as keyof typeof tokens.spacing]}`}
                    {direction === 'm' &&
                      `margin: ${tokens.spacing[selectedSpacing as keyof typeof tokens.spacing]}`}
                    {direction === 'mx' &&
                      `margin-left/right: ${tokens.spacing[selectedSpacing as keyof typeof tokens.spacing]}`}
                    {direction === 'my' &&
                      `margin-top/bottom: ${tokens.spacing[selectedSpacing as keyof typeof tokens.spacing]}`}
                  </div>
                </div>
                <div
                  className="mt-4 p-4 bg-muted rounded text-xs font-mono"

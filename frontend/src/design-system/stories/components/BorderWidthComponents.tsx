...
export const InteractiveBorderStates = () => (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
            { name: 'Default', className: 'border-border', color: tokens.colors.border },
            { name: 'Focus', className: 'border-primary ring-2 ring-primary/20', color: tokens.colors.primary[500] },
            { name: 'Error', className: 'border-destructive', color: tokens.colors.destructive[500] },
            { name: 'Success', className: 'border-green-500', color: tokens.colors.accent[500] }
        ].map((state) => (
            ...
            <Card key={radius} className="p-4 space-y-3">
                ...
                <div
                    ...
                    style={{
                        ...
                        borderRadius: radius === 'rounded-none' ? '0' :
                            radius === 'rounded-md' ? tokens.borderRadius.md :
                                radius === 'rounded-lg' ? tokens.borderRadius.lg :

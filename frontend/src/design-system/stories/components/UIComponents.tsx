...
import { Card, applyTypographyStyle, Button } from './CoreComponents';
...
export const DashboardHeader = ({
    ...
    <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
            ...
            <div>
                <h4 style={applyTypographyStyle('title')} className="text-gray-900">{title}</h4>
                <p style={applyTypographyStyle('caption')} className="text-gray-500">{subtitle}</p>
            </div>
        </div>
        <div className="flex items-center gap-3">
            <div
...
export const ChartArea = ({
    ...
    <div className="lg:col-span-2 p-4 rounded-lg border border-gray-200">
        <h5 style={applyTypographyStyle('subtitle')} className="text-gray-900 mb-4">{title}</h5>
        <div
    ...
    <div className="p-4 rounded-lg border border-gray-200">
        ...
        <div className="space-y-3">
            {actions.map((action, index) => (
                <Button key={index} variant={action.variant || 'primary'} className="w-full">
                    {action.label}
                </Button>
            ))}
        </div>

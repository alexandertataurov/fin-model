...
const meta: Meta = {
    title: 'Design System/1 - Foundations/Display',
    tags: ['autodocs'],
    parameters: {
        layout: 'padded',
        docs: {
...
const DisplayDemo = ({ name, display, description }: {
    name: string;
    display: string;
    description: string;
}) => (
            ...
            <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div className="p-6 rounded-xl border bg-card space-y-4">
                        ...
                        <div className="text-xs text-muted-foreground">Element is visible and takes up space</div>
                        <div className="space-y-2">
                    ...
                    <div className="p-6 rounded-xl border bg-card space-y-4">
                        ...
                        <div className="text-xs text-muted-foreground">Element is hidden but still takes up space</div>
                        <div className="space-y-2">
                            <div className="bg-accent/10 border border-accent/20 rounded p-2 text-xs text-accent">
                                <span className="bg-accent/20 px-1 rounded">Item 1</span>
                                <span className="bg-accent/20 px-1 rounded invisible">Hidden</span>
                                <span className="bg-accent/20 px-1 rounded">Item 3</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-6 rounded-xl border bg-card space-y-4">
                        <div className="text-sm font-medium text-foreground">Display None</div>
                        <div className="text-xs text-muted-foreground">Element is completely removed</div>
                        <div className="space-y-2">
                            <div className="bg-accent/10 border border-accent/20 rounded p-2 text-xs text-accent">
                                <span className="bg-accent/20 px-1 rounded">Item 1</span>
            ...
            <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="p-6 rounded-xl border bg-card space-y-4">
                        ...
                        <div className="text-xs text-muted-foreground">Grid that adapts to screen size</div>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                            {Array.from({ length: 6 }, (_, i) => (
                                <div key={i} className="bg-primary/10 border border-primary/20 rounded p-2 text-xs text-primary text-center">
                                    Item {i + 1}
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="p-6 rounded-xl border bg-card space-y-4">
                        <div className="text-sm font-medium text-foreground">Responsive Visibility</div>
                        <div className="text-xs text-muted-foreground">Elements that show/hide based on screen size</div>
                        <div className="space-y-2">
                            <div className="bg-secondary/10 border border-secondary/20 rounded p-2 text-xs text-secondary">
                                <span className="bg-secondary/20 px-1 rounded">Always Visible</span>
                                <span className="bg-secondary/20 px-1 rounded block sm:hidden">Mobile Only</span>
                                <span className="bg-secondary/20 px-1 rounded hidden sm:block lg:hidden">Tablet Only</span>
                                <span className="bg-secondary/20 px-1 rounded hidden lg:block">Desktop Only</span>
                            </div>
                        </div>
                        <div className="text-xs text-muted-foreground font-mono">

...
const meta: Meta = {
  title: 'Design System/1 - Foundations/5 - Shadows',
  tags: ['autodocs'],
  parameters: {
    layout: 'padded',
    docs: {
    ...
    <Card className="group relative p-4 hover:border-gray-300 transition-all duration-200 hover:shadow-md">
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div style={applyTypographyStyle('subtitle')} className="text-gray-900 mb-1">{name}</div>
          {category && (
            <div style={applyTypographyStyle('caption')} className="text-gray-400 mb-1 font-medium">{category}</div>
          )}
          <div style={applyTypographyStyle('caption')} className="text-gray-500 font-mono bg-gray-50 px-2 py-1 rounded border break-all">{shadow}</div>
          {description && <div style={applyTypographyStyle('caption')} className="text-gray-600 mt-2 italic">{description}</div>}
        </div>
      </div>
    </Card>
  );
    ...
    <div className="space-y-16">
      ...
      <div className="space-y-8">
        <div className="text-center">
          <h3 style={applyTypographyStyle('headline')} className="text-gray-900 mb-4">Basic Shadow Scale</h3>
          <p style={applyTypographyStyle('subtitle')} className="text-gray-600 max-w-2xl mx-auto">Progressive shadow intensities for different elevation levels</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {[
            { name: 'Extra Small', key: 'sm', description: 'Subtle depth for small elements' },
            { name: 'Small', key: 'base', description: 'Light elevation for cards and buttons' },
      ...
      <div className="space-y-8">
        <div className="text-center">
          <h3 style={applyTypographyStyle('headline')} className="text-gray-900 mb-4">Interactive Shadows</h3>
          <p style={applyTypographyStyle('subtitle')} className="text-gray-600 max-w-2xl mx-auto">Shadows for different interaction states and components</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {[
            { name: 'Card', shadow: tokens.shadows.md, description: 'Default card shadow' },
            { name: 'Card Hover', shadow: tokens.shadows.lg, description: 'Elevated state on hover' },
            { name: 'Button', shadow: tokens.shadows.sm, description: 'Default button shadow' },
            { name: 'Button Hover', shadow: tokens.shadows.md, description: 'Elevated state on hover' },
            { name: 'Button Active', shadow: tokens.shadows.xs, description: 'Pressed state shadow' },
            { name: 'Modal', shadow: tokens.shadows.xl, description: 'Modal overlay shadow' },
            { name: 'Dropdown', shadow: tokens.shadows.lg, description: 'Dropdown menu shadow' },
            { name: 'Tooltip', shadow: tokens.shadows.md, description: 'Tooltip shadow' },
      ...
      <div className="space-y-8">
        <div className="text-center">
          <h3 style={applyTypographyStyle('headline')} className="text-gray-900 mb-4">Special Effects</h3>
          <p style={applyTypographyStyle('subtitle')} className="text-gray-600 max-w-2xl mx-auto">Glow effects, inner shadows, and focus states</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {[
            { name: 'Primary Glow', shadow: `0 0 0 1px ${tokens.colors.primary[500]}20, 0 0 0 4px ${tokens.colors.primary[500]}10`, description: 'Primary brand glow effect' },
            { name: 'Large Glow', shadow: `0 0 0 1px ${tokens.colors.primary[500]}20, 0 0 0 8px ${tokens.colors.primary[500]}10`, description: 'Enhanced glow for emphasis' },
            { name: 'Accent Glow', shadow: `0 0 0 1px ${tokens.colors.accent[500]}20, 0 0 0 4px ${tokens.colors.accent[500]}10`, description: 'Success state glow' },
            { name: 'Destructive Glow', shadow: `0 0 0 1px ${tokens.colors.destructive[500]}20, 0 0 0 4px ${tokens.colors.destructive[500]}10`, description: 'Error state glow' },
            { name: 'Inner Shadow', shadow: 'inset 0 2px 4px 0 rgb(0 0 0 / 0.06)', description: 'Pressed or inset effect' },
            { name: 'Large Inner', shadow: 'inset 0 4px 8px 0 rgb(0 0 0 / 0.1)', description: 'Stronger inset effect' },
            { name: 'Focus Ring', shadow: `0 0 0 3px ${tokens.colors.primary[500]}20`, description: 'Primary focus indicator' },
            { name: 'Accent Focus', shadow: `0 0 0 3px ${tokens.colors.accent[500]}20`, description: 'Accent focus indicator' },
            { name: 'Destructive Focus', shadow: `0 0 0 3px ${tokens.colors.destructive[500]}20`, description: 'Error focus indicator' },
          ].map(({ name, shadow, description }) => (
            <ShadowSwatch
              key={name}
              name={name}
      ...
      <div>
        ...
        <div className="mb-12">
          <div className="text-center mb-6">
            <h4 style={applyTypographyStyle('title')} className="text-gray-900 mb-2">Layered Interface Example</h4>
            <p style={applyTypographyStyle('body')} className="text-gray-600">How shadows create visual hierarchy in complex interfaces</p>
          </div>
          <div className="relative h-96 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl border-2 border-gray-200 overflow-hidden p-8">
            ...
            {/* Glow Effect */}
            <div className="absolute top-24 right-8 w-20 h-20 rounded-lg bg-white border border-gray-200 flex items-center justify-center text-sm text-gray-600" style={{ boxShadow: `0 0 0 1px ${tokens.colors.primary[500]}20, 0 0 0 4px ${tokens.colors.primary[500]}10` }}>
              Glow
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Card className="group p-8 hover:border-gray-300 transition-all duration-200 hover:shadow-lg">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h4 style={applyTypographyStyle('title')} className="text-gray-900">Base Level</h4>
            </div>
            <p style={applyTypographyStyle('body')} className="text-gray-600 mb-6">Subtle shadows for background elements, borders, and low-priority content.</p>
          ...
          <Card className="group p-8 hover:border-gray-300 transition-all duration-200 hover:shadow-lg">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h4 style={applyTypographyStyle('title')} className="text-gray-900">Content Level</h4>
            </div>
            <p style={applyTypographyStyle('body')} className="text-gray-600 mb-6">Standard elevation for cards, buttons, and interactive elements.</p>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between items-center">
                <span className="text-gray-700 font-medium">Shadow:</span>
          ...
          <Card className="group p-8 hover:border-gray-300 transition-all duration-200 hover:shadow-lg">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h4 style={applyTypographyStyle('title')} className="text-gray-900">Overlay Level</h4>
            </div>
            <p style={applyTypographyStyle('body')} className="text-gray-600 mb-6">High elevation for modals, dropdowns, and floating elements.</p>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between items-center">
                <span className="text-gray-700 font-medium">Shadow:</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          },
          {
            name: 'Focus States',
            states: [
              { name: 'Primary', shadow: `0 0 0 3px ${tokens.colors.primary[500]}20` },
              { name: 'Accent', shadow: `0 0 0 3px ${tokens.colors.accent[500]}20` },
              { name: 'Destructive', shadow: `0 0 0 3px ${tokens.colors.destructive[500]}20` },
            ]
          },
          {
            name: 'Glow Effects',
            states: [
              { name: 'Primary', shadow: `0 0 0 1px ${tokens.colors.primary[500]}20, 0 0 0 4px ${tokens.colors.primary[500]}10` },
              { name: 'Accent', shadow: `0 0 0 1px ${tokens.colors.accent[500]}20, 0 0 0 4px ${tokens.colors.accent[500]}10` },
              { name: 'Destructive', shadow: `0 0 0 1px ${tokens.colors.destructive[500]}20, 0 0 0 4px ${tokens.colors.destructive[500]}10` },
            ]
          },
        ].map(({ name, states }) => (
          <Card key={name} className="p-6">
            <h4 style={applyTypographyStyle('title')} className="text-gray-900 mb-4">{name}</h4>
              ...
              {states.map(({ name: stateName, shadow }) => (
                <div key={stateName} className="flex items-center gap-4 p-3 rounded-lg bg-gray-50 border border-gray-100">
                  ...
                  <div className="flex-1">
                    <div style={applyTypographyStyle('subtitle')} className="text-gray-900">{stateName}</div>
                    <div style={applyTypographyStyle('caption')} className="text-gray-500 font-mono truncate">{shadow}</div>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 p-4 rounded-lg border border-gray-200" style={{ boxShadow: tokens.shadows.sm }}>
            ...
            <div className="h-48 bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg flex items-center justify-center">
              <div className="text-center">
                <div style={applyTypographyStyle('caption')} className="text-gray-500 mb-2">Chart Visualization</div>
          ...
          <div className="p-4 rounded-lg border border-gray-200" style={{ boxShadow: tokens.shadows.sm }}>
            ...
            <div className="space-y-3">
              <button
                ...
                style={{ background: tokens.colors.primary[500], boxShadow: tokens.shadows.sm }}
              >
                Add Investment
              </button>
              <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <Card className="p-6" style={{ boxShadow: tokens.shadows.md }}>
          ...
          <div className="space-y-4">
            <div>
              <label style={applyTypographyStyle('subtitle')} className="block text-gray-700 mb-2">Email Address</label>
              <input
                type="email"
            ...
            <div>
              <label style={applyTypographyStyle('subtitle')} className="block text-gray-700 mb-2">Investment Amount</label>
              <input
                type="number"
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none transition-shadow duration-200"
                placeholder="$10,000"
        ...
        <Card className="p-6" style={{ boxShadow: tokens.shadows.md }}>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 p-3 rounded-lg border border-gray-200" style={{ boxShadow: tokens.shadows.sm }}>
              <div className="w-3 h-3 rounded-full" style={{ background: tokens.colors.accent[500] }}></div>
              <span style={applyTypographyStyle('body')} className="text-gray-700">Transaction Successful</span>
            </div>
            <div className="flex items-center gap-3 p-3 rounded-lg border border-gray-200" style={{ boxShadow: tokens.shadows.sm }}>
              <div className="w-3 h-3 rounded-full" style={{ background: tokens.colors.warning }}></div>
              <span style={applyTypographyStyle('body')} className="text-gray-700">Risk Level: Medium</span>
            </div>
            <div className="flex items-center gap-3 p-3 rounded-lg border border-gray-200" style={{ boxShadow: tokens.shadows.sm }}>
              <div className="w-3 h-3 rounded-full" style={{ background: tokens.colors.danger }}></div>
              <span style={applyTypographyStyle('body')} className="text-gray-700">Account Locked</span>
            </div>
            <div className="flex items-center gap-3 p-3 rounded-lg border border-gray-200" style={{ boxShadow: tokens.shadows.sm }}>
              <div className="w-3 h-3 rounded-full" style={{ background: tokens.colors.info }}></div>
              <span style={applyTypographyStyle('body')} className="text-gray-700">New Feature Available</span>
            </div>
          </div>
        </Card>
      </div>
        ...
        <div className="space-y-3">
          <div className="p-4 rounded-lg border-l-4" style={{ background: `${tokens.colors.accent[50]}`, borderLeftColor: tokens.colors.accent[500], boxShadow: tokens.shadows.sm }}>
            <div className="flex items-center gap-3">
              ...
              <div>
                <div style={applyTypographyStyle('subtitle')} className="text-gray-900">Investment Completed</div>
                <div style={applyTypographyStyle('body')} className="text-gray-600">Your $5,000 investment has been successfully processed.</div>
              </div>
            </div>
          </div>
          <div className="p-4 rounded-lg border-l-4" style={{ background: `${tokens.colors.warning}10`, borderLeftColor: tokens.colors.warning, boxShadow: tokens.shadows.sm }}>
            <div className="flex items-center gap-3">
              ...
              <div>
                <div style={applyTypographyStyle('subtitle')} className="text-gray-900">Security Alert</div>
                <div style={applyTypographyStyle('body')} className="text-gray-600">Unusual login activity detected. Please review your account.</div>
              </div>
            </div>
          </div>
          <div className="p-4 rounded-lg border-l-4" style={{ background: `${tokens.colors.danger}10`, borderLeftColor: tokens.colors.danger, boxShadow: tokens.shadows.sm }}>
            <div className="flex items-center gap-3">
              ...
              <div>
                <div style={applyTypographyStyle('subtitle')} className="text-gray-900">Transaction Failed</div>
                <div style={applyTypographyStyle('body')} className="text-gray-600">Insufficient funds. Please check your account balance.</div>
              </div>
            </div>
          </div>
        </div>
    ...
    <div className="space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div style={applyTypographyStyle('subtitle')} className="text-gray-900">Subtle Depth</div>
                <div style={applyTypographyStyle('body')} className="text-gray-600">Shadows create hierarchy without overwhelming the interface</div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-4 h-4 rounded-lg bg-white border border-gray-200" style={{ boxShadow: tokens.shadows.md }}></div>
              <div>
                <div style={applyTypographyStyle('subtitle')} className="text-gray-900">Consistent Elevation</div>
                <div style={applyTypographyStyle('body')} className="text-gray-600">Systematic shadow levels for predictable depth</div>
              </div>
            </div>
          </div>
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-4 h-4 rounded-lg bg-white border border-gray-200" style={{ boxShadow: `0 0 0 1px ${tokens.colors.primary[500]}20, 0 0 0 4px ${tokens.colors.primary[500]}10` }}></div>
              <div>
                <div style={applyTypographyStyle('subtitle')} className="text-gray-900">Interactive Feedback</div>
                <div style={applyTypographyStyle('body')} className="text-gray-600">Shadows respond to user interactions</div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-4 h-4 rounded-lg bg-white border border-gray-200" style={{ boxShadow: `0 0 0 3px ${tokens.colors.primary[500]}20` }}></div>
              <div>
                <div style={applyTypographyStyle('subtitle')} className="text-gray-900">Accessibility</div>
                <div style={applyTypographyStyle('body')} className="text-gray-600">Clear focus indicators and contrast</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <Card className="p-8" style={{ boxShadow: tokens.shadows.md }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            <h5 style={applyTypographyStyle('subtitle')} className="text-gray-900 mb-3">Basic Shadows</h5>
          ...
          <div>
            <h5 style={applyTypographyStyle('subtitle')} className="text-gray-900 mb-3">Interactive Shadows</h5>
            <ul className="space-y-2 text-sm text-gray-600">
          ...
          <div>
            <h5 style={applyTypographyStyle('subtitle')} className="text-gray-900 mb-3">Special Effects</h5>
            <ul className="space-y-2 text-sm text-gray-600">
      ...
      {/* Best Practices */}
      <Card className="p-8" style={{ boxShadow: tokens.shadows.md }}>
        <h4 style={applyTypographyStyle('title')} className="text-gray-900 mb-6">✨ Best Practices</h4>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <h5 style={applyTypographyStyle('subtitle')} className="text-gray-900 mb-3">Do's</h5>
            <ul className="space-y-2 text-sm text-gray-600">
          ...
          <div>
            <h5 style={applyTypographyStyle('subtitle')} className="text-gray-900 mb-3">Don'ts</h5>
            <ul className="space-y-2 text-sm text-gray-600">
  ...
  render: () => (
    ...
    >
      {Object.entries(tokens.shadows).map(([name, shadow]) => (
        ...
        >
          <div style={applyTypographyStyle('caption')} className="text-muted-foreground mb-3">{name}</div>
          <div

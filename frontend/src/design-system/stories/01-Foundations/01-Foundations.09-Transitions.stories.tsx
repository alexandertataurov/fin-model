...
const meta: Meta = {
  title: 'Design System/1 - Foundations/Transitions',
  tags: ['autodocs'],
  parameters: {
    layout: 'padded',
    docs: {
        ...
        <div className="space-y-12">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {Object.entries(tokens.transitions).slice(0, 3).map(([name, transition]) => (
                <Card key={name} className="p-6">
                  <div
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {Object.entries(tokens.transitions).slice(3, 6).map(([name, transition]) => (
                <Card key={name} className="p-6 cursor-pointer transition-all">
                  <div
                    className="text-sm font-medium mb-4"
                    style={{
                      fontSize: tokens.typography.fontSize.sm,
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {Object.entries(tokens.transitions).slice(6, 9).map(([name, transition]) => (
                <Card key={name} className="p-6">
                  <div
                    className="text-sm font-medium mb-4"
                    style={{
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                >
                  ✓
                </span> Use consistent transition tokens
              </div>
              <div
                className="text-sm"
                style={{ fontSize: tokens.typography.fontSize.sm }}
              >
                ...
                >
                  ✓
                </span> Match transition speed to interaction type
              </div>
              <div
                className="text-sm"
                style={{ fontSize: tokens.typography.fontSize.sm }}
              >
                ...
                >
                  ✓
                </span> Consider user motion preferences
              </div>
              <div
                className="text-sm"
                style={{ fontSize: tokens.typography.fontSize.sm }}
              >
                ...
                >
                  ✗
                </span> Don't use transitions for critical feedback
              </div>
              <div
                className="text-sm"
                style={{ fontSize: tokens.typography.fontSize.sm }}
              >
                ...
                >
                  ✗
                </span> Don't mix different transition speeds
              </div>
              <div
                className="text-sm"
                style={{ fontSize: tokens.typography.fontSize.sm }}
              >
                ...
                >
                  ✗
                </span> Don't use transitions that cause motion sickness
              </div>
            </div>
          </Card>
        </div>
      ...
      <div>
        ...
        <div className="space-y-6">
          <Card className="p-6">
            ...
            >
              Always respect the user's motion preferences by checking the <code

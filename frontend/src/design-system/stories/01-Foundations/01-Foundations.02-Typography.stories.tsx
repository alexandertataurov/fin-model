...
const meta: Meta = {
  title: 'Design System/1 - Foundations/2 - Typography',
  tags: ['autodocs'],
  parameters: {
    layout: 'padded',
    docs: {
  ...
  render: () => (
    <div className="space-y-16">
      ...
      <Card className="hover:border-gray-300 overflow-hidden">
        <div style={applyTextStyle('headline')} className="text-gray-900 mb-4 break-words">
          Q3 Financial Performance Report
        </div>
        <div style={applyTextStyle('subtitle')} className="text-gray-600 mb-6 break-words">
          Comprehensive analysis of quarterly results and market trends
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <div style={applyTextStyle('title')} className="text-gray-800 mb-3 break-words">
              Key Metrics
            </div>
        ...
        <div style={applyTextStyle('caption')} className="text-gray-500 mt-6 pt-4 border-t border-gray-100 break-words">
      ...
      <div className="p-6 rounded-xl border border-gray-200 bg-gray-900 text-white overflow-hidden">
        <div style={applyTextStyle('subtitle')} className="text-gray-300 mb-4 break-words">
          Risk Calculation Algorithm
        </div>
        <div style={applyTextStyle('code')} className="text-green-400 font-mono overflow-x-auto">
  ...
  render: () => (
    <div className="space-y-16">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-sm overflow-hidden">
        <h4 style={applyTypographyStyle('title')} className="text-gray-900 mb-6 break-words">🌟 Design Philosophy</h4>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-4 h-4 rounded-full bg-indigo-500 flex-shrink-0"></div>
              <div>
                <div className="font-semibold text-gray-900 break-words">Sophisticated Typography</div>
                <div className="text-sm text-gray-600 break-words">Professional and elegant type system for financial applications</div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-4 h-4 rounded-full bg-gray-500 flex-shrink-0"></div>
              <div>
                <div className="font-semibold text-gray-900 break-words">Clear Hierarchy</div>
                <div className="text-sm text-gray-600 break-words">Well-defined typography scale for optimal readability</div>
              </div>
            </div>
          </div>
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-semibold text-gray-900 break-words">Accessibility First</div>
                <div className="text-sm text-gray-600 break-words">WCAG compliant with proper contrast ratios</div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-4 h-4 rounded-full bg-red-500 flex-shrink-0"></div>
              <div>
                <div className="font-semibold text-gray-900 break-words">Consistent Patterns</div>
                <div className="text-sm text-gray-600 break-words">Predefined text styles for maintainable design</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-sm overflow-hidden">
        <h4 style={applyTypographyStyle('title')} className="text-gray-900 mb-6 break-words">🚀 Usage Guidelines</h4>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            <h5 className="font-semibold text-gray-900 mb-3 break-words">Headlines & Titles</h5>
            <ul className="space-y-2 text-sm text-gray-600">
                                      <li className="break-words">• Headline: Main page titles, hero sections</li>
                        <li className="break-words">• Subheadline: Section headers, major divisions</li>
                        <li className="break-words">• Title: Component titles, card headers</li>
                        <li className="break-words">• Subtitle: Supporting text, descriptions</li>
            </ul>
          </div>
          <div>
            <h5 className="font-semibold text-gray-900 mb-3 break-words">Body & Content</h5>
            <ul className="space-y-2 text-sm text-gray-600">
                                      <li className="break-words">• Body: Main content, paragraphs</li>
                        <li className="break-words">• Caption: Metadata, timestamps</li>
                        <li className="break-words">• Code: Code snippets, technical content</li>
                        <li className="break-words">• Elegant: Premium content, quotes</li>
            </ul>
          </div>
          <div>
            <h5 className="font-semibold text-gray-900 mb-3 break-words">Font Families</h5>
            <ul className="space-y-2 text-sm text-gray-600">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-sm overflow-hidden">
        <h4 style={applyTypographyStyle('title')} className="text-gray-900 mb-6 break-words">♿ Accessibility</h4>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <h5 className="font-semibold text-gray-900 mb-3 break-words">Contrast Requirements</h5>
            <ul className="space-y-2 text-sm text-gray-600">
              <li className="break-words">• All text meets WCAG 2.1 AA standards</li>
              <li className="break-words">• Minimum 4.5:1 contrast ratio for normal text</li>
              <li className="break-words">• Minimum 3:1 contrast ratio for large text</li>
            </ul>
          </div>
          <div>
            <h5 className="font-semibold text-gray-900 mb-3 break-words">Best Practices</h5>
            <ul className="space-y-2 text-sm text-gray-600">
              <li className="break-words">• Use semantic HTML elements</li>
              <li className="break-words">• Maintain proper heading hierarchy</li>
              <li className="break-words">• Ensure sufficient line height for readability</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="space-y-4">
          <Card className="group p-6 hover:shadow-md overflow-hidden">
            <h4 className="font-semibold text-lg text-gray-900 mb-4 break-words">Headlines & Titles</h4>
            <ul className="text-base text-gray-600 space-y-2 leading-relaxed">
              <li className="break-words">• Use headline for main page titles</li>
              <li className="break-words">• Use subheadline for section headers</li>
              <li className="break-words">• Use title for component headers</li>
              <li className="break-words">• Use subtitle for supporting text</li>
            </ul>
          </Card>

          <Card className="group p-6 hover:shadow-md overflow-hidden">
            <h4 className="font-semibold text-lg text-gray-900 mb-4 break-words">Body & Content</h4>
            <ul className="text-base text-gray-600 space-y-2 leading-relaxed">
        ...
        <div className="space-y-4">
          <Card className="group p-6 hover:shadow-md overflow-hidden">
            <h4 className="font-semibold text-lg text-gray-900 mb-4 break-words">Font Families</h4>
            <ul className="text-base text-gray-600 space-y-2 leading-relaxed">
          ...
          <Card className="group p-6 hover:shadow-md overflow-hidden">
            <h4 className="font-semibold text-lg text-gray-900 mb-4 break-words">Accessibility</h4>
            <ul className="text-base text-gray-600 space-y-2 leading-relaxed">
...
export const LegalDocumentation: Story = {
  render: () => (
    <div className="space-y-16">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-sm overflow-hidden">
        <div style={applyTextStyle('headline')} className="text-gray-900 mb-6 break-words">
          Investment Management Agreement
        </div>
        <div style={applyTextStyle('subtitle')} className="text-gray-600 mb-8 break-words">
        ...
        <div className="space-y-6">
          <div>
            ...
            <div style={applyTextStyle('body')} className="text-gray-700 space-y-3">
              <p className="break-words">
                <strong>1.1 "Account"</strong> means the investment account established and maintained by the Manager for the Client pursuant to this Agreement.
              </p>
              <p className="break-words">
                <strong>1.2 "Assets"</strong> means all cash, securities, and other property held in the Account from time to time.
              </p>
              <p className="break-words">
                <strong>1.3 "Manager"</strong> means FinVision Capital Management, a registered investment adviser.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div style={applyTextStyle('body')} className="text-gray-700 space-y-3">
              <p className="break-words">
                The Client hereby appoints the Manager as investment adviser with full authority to buy, sell, and otherwise trade securities and other investments in the Account, subject to the investment objectives and guidelines set forth in Schedule A.
              </p>
              <p className="break-words">
                The Manager shall exercise reasonable care and diligence in the management of the Account and shall act in the best interests of the Client at all times.
              </p>
            </div>
          </div>
        </div>

        <div style={applyTextStyle('caption')} className="text-gray-500 mt-8 pt-6 border-t border-gray-100 break-words">
          Document ID: IVM-2024-001 • Effective Date: January 1, 2024 • Version 2.1
        </div>
      </div>
    </div>
  ),
  ...
  render: () => (
    <div className="space-y-16">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-sm overflow-hidden">
        ...
        <div className="space-y-8">
          <div>
            <div style={applyTextStyle('title')} className="text-gray-800 mb-4 break-words">
              Learning Objectives
            </div>
            <div style={applyTextStyle('body')} className="text-gray-700 space-y-2">
              <div className="flex items-start space-x-2">
                <span className="text-indigo-600 font-bold mt-1">•</span>
                <span className="break-words">Understand modern portfolio theory and efficient frontier concepts</span>
              </div>
              <div className="flex items-start space-x-2">
                <span className="text-indigo-600 font-bold mt-1">•</span>
                <span className="break-words">Master Value at Risk (VaR) calculations and stress testing methodologies</span>
              </div>
              <div className="flex items-start space-x-2">
                <span className="text-indigo-600 font-bold mt-1">•</span>
                <span className="break-words">Apply Monte Carlo simulation techniques to portfolio optimization</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div style={applyTextStyle('body')} className="text-gray-700 space-y-4">
              <div>
                <div style={applyTextStyle('subtitle')} className="text-gray-800 mb-2 break-words">
                  Efficient Frontier
                </div>
                <p className="break-words">
              ...
              <div>
                ...
                <p className="break-words">
                  VaR measures the maximum potential loss of a portfolio over a specific time period with a given confidence level. For example, a 95% VaR of $1 million means there is a 5% chance that the portfolio will lose more than $1 million in the specified time period.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
            <div style={applyTextStyle('elegant')} className="text-gray-800 mb-4 break-words">
              "The essence of investment management is the management of risks, not the management of returns."
            </div>
            <div style={applyTextStyle('caption')} className="text-gray-600 break-words">
        ...
        <div style={applyTextStyle('caption')} className="text-gray-500 mt-8 pt-6 border-t border-gray-100 break-words">
          Course Duration: 8 weeks • Difficulty: Advanced • Prerequisites: Financial Mathematics, Statistics
        </div>
      </div>
    </div>
  ),

...
const meta: Meta = {
  title: 'Design System/1 - Foundations/Position',
  tags: ['autodocs'],
  parameters: {
    layout: 'padded',
    docs: {
...
const PositionDemo = ({ name, position, top, right, bottom, left, zIndex, className = '' }: {
  name: string;
  position: string;
  top?: string;
  right?: string;
...
const ZIndexDemo = ({ name, zIndex, description, className = '' }: {
  name: string;
  zIndex: string;
  description: string;
  className?: string;
...
const StackingDemo = ({ name, layers, className = '' }: {
  name: string;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="p-6 rounded-xl border bg-card space-y-4">
            ...
            <div className="relative inline-block">
              ...
              <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 bg-gray-800 text-white px-2 py-1 rounded text-xs whitespace-nowrap" style={{ zIndex: 1060 }}>
                This is a tooltip
          ...
          <div className="p-6 rounded-xl border bg-card space-y-4">
            ...
            <div className="relative inline-block">
              ...
              <div className="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center" style={{ zIndex: 10 }}>
                3
              </div>
            </div>
            <div className="text-xs text-muted-foreground">
          ...
          <div className="p-6 rounded-xl border bg-card space-y-4">
            ...
            <div className="relative h-32 bg-muted/10 border border-muted/20 rounded overflow-hidden">
              <div className="absolute inset-0 bg-black/50 flex items-center justify-center" style={{ zIndex: 1040 }}>
                <div className="bg-white rounded-lg p-4 max-w-sm mx-4">
                  <div className="text-sm font-medium">Modal Title</div>
                  <div className="text-xs text-muted-foreground mt-1">Modal content goes here</div>
                </div>
              </div>
            </div>
            <div className="text-xs text-muted-foreground">
          ...
          {/* Sticky Header */}
          <div className="p-6 rounded-xl border bg-card space-y-4">
            <div className="text-sm font-medium text-foreground">Sticky Header</div>
            <div className="space-y-2">
              <div className="bg-blue-600 text-white px-4 py-2 rounded" style={{ position: 'sticky', top: '0', zIndex: 1020 }}>
                Sticky Header
              </div>
              <div className="space-y-1">
                {Array.from({ length: 5 }, (_, i) => (
                  <div key={i} className="bg-gray-100 px-4 py-2 rounded text-sm">
                    Content item {i + 1}
                  </div>
                ))}
              </div>

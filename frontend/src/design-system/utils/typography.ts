...
export const typography = {
    ...
    getStyle: (family: string, size: string, weight: string, lineHeight?: string, letterSpacing?: string) => ({
        fontFamily: tokenVal(tokens.typography.fontFamily[family as keyof typeof tokens.typography.fontFamily]),
        fontSize: tokenVal(tokens.typography.fontSize[size as keyof typeof tokens.typography.fontSize]),
        fontWeight: Number(tokenVal(tokens.typography.fontWeight[weight as keyof typeof tokens.typography.fontWeight])),
        ...(lineHeight && { lineHeight: tokenVal(tokens.typography.lineHeight[lineHeight as keyof typeof tokens.typography.lineHeight]) }),
        ...(letterSpacing && { letterSpacing: tokenVal(tokens.typography.letterSpacing[letterSpacing as keyof typeof tokens.typography.letterSpacing]) }),
    }),
};

  ...
  const LineItem: React.FC<{
    ...
    >
      ...
      <div className="flex items-center space-x-2">
        ...
        {value < 0 && <TrendingDown className="w-4 h-4 text-red-500" />}
      </div>
    </div>
  );
      ...
      <CardContent className="space-y-4">
        ...
        <ExpandableSection title="Revenue" sectionKey="revenue">
          <LineItem
            ...
            value={data.revenue.product_revenue}
            indent={1}
          />
          <LineItem
            label="Service Revenue"
            value={data.revenue.service_revenue}
            indent={1}
          />
          <LineItem
            label="Licensing Revenue"
            value={data.revenue.licensing_revenue}
            indent={1}
          />
          <LineItem
            label="Royalty Revenue"
            value={data.revenue.royalty_revenue}
            indent={1}
          />
          <LineItem
            label="Interest Income"
            value={data.revenue.interest_income}
            indent={1}
          />
          <LineItem
            label="Other Revenue"
            value={data.revenue.other_revenue}
            indent={1}
          />
          <LineItem
            label="Total Revenue"
        ...
        <ExpandableSection title="Cost of Goods Sold" sectionKey="cogs">
          <LineItem
            ...
            value={data.cost_of_goods_sold.direct_materials}
            indent={1}
          />
          <LineItem
            label="Direct Labor"
            value={data.cost_of_goods_sold.direct_labor}
            indent={1}
          />
          <LineItem
            label="Manufacturing Overhead"
            value={data.cost_of_goods_sold.manufacturing_overhead}
            indent={1}
          />
          <LineItem
            label="Freight & Delivery"
            value={data.cost_of_goods_sold.freight_and_delivery}
            indent={1}
          />
          <LineItem
            label="Quality Control"
            value={data.cost_of_goods_sold.quality_control}
            indent={1}
          />
          <LineItem
            label="Warranty Costs"
            value={data.cost_of_goods_sold.warranty_costs}
            indent={1}
          />
          <LineItem
            label="Total COGS"
        ...
        <ExpandableSection title="Operating Expenses" sectionKey="opex">
          ...
          <div className="bg-gray-50 p-2">
            ...
            <LineItem
              ...
              value={data.operating_expenses.sales_commission}
              indent={2}
            />
            <LineItem
              label="Marketing Spend"
              value={data.operating_expenses.marketing_spend}
              indent={2}
            />
            <LineItem
              label="Advertising"
              value={data.operating_expenses.advertising}
              indent={2}
            />
            <LineItem
              label="Trade Shows"
              value={data.operating_expenses.trade_shows}
              indent={2}
            />
            <LineItem
              label="Sales Team Salaries"
              value={data.operating_expenses.sales_team_salaries}
              indent={2}
            />
            <LineItem
              label="Total Sales & Marketing"
              value={data.operating_expenses.total_sales_marketing}
              indent={1}
              isSubtotal={true}
            />
          </div>
          ...
          <div className="bg-gray-50 p-2">
            ...
            <LineItem
              label="R&D Salaries"
              value={data.operating_expenses.rnd_salaries}
              indent={2}
            />
            <LineItem
              label="R&D Equipment"
              value={data.operating_expenses.rnd_equipment}
              indent={2}
            />
            <LineItem
              label="R&D Outsourcing"
              value={data.operating_expenses.rnd_outsourcing}
              indent={2}
            />
            <LineItem
              label="Total R&D"
              value={data.operating_expenses.total_rnd}
              indent={1}
              isSubtotal={true}
            />
          </div>
          ...
          <div className="bg-gray-50 p-2">
            ...
            <LineItem
              ...
              value={data.operating_expenses.executive_salaries}
              indent={2}
            />
            <LineItem
              label="Admin Salaries"
              value={data.operating_expenses.admin_salaries}
              indent={2}
            />
            <LineItem
              label="Office Rent"
              value={data.operating_expenses.office_rent}
              indent={2}
            />
            <LineItem
              label="Utilities"
              value={data.operating_expenses.utilities}
              indent={2}
            />
            <LineItem
              label="Insurance"
              value={data.operating_expenses.insurance}
              indent={2}
            />
            <LineItem
              label="Legal Fees"
              value={data.operating_expenses.legal_fees}
              indent={2}
            />
            <LineItem
              label="Accounting Fees"
              value={data.operating_expenses.accounting_fees}
              indent={2}
            />
            <LineItem
              label="IT Infrastructure"
              value={data.operating_expenses.it_infrastructure}
              indent={2}
            />
            <LineItem
              label="Travel Expenses"
              value={data.operating_expenses.travel_expenses}
              indent={2}
            />
            <LineItem
              label="Training"
              value={data.operating_expenses.training}
              indent={2}
            />
            <LineItem
              label="Total G&A"
              value={data.operating_expenses.total_general_admin}
              indent={1}
              isSubtotal={true}
            />
          </div>
        ...
        <ExpandableSection title="Other Income/Expense" sectionKey="other">
          <LineItem
            ...
            value={data.other_income_expense.interest_expense}
            indent={1}
          />
          <LineItem
            label="Interest Income"
            value={data.other_income_expense.interest_income}
            indent={1}
          />
          <LineItem
            label="FX Gain/Loss"
            value={data.other_income_expense.foreign_exchange_gain_loss}
            indent={1}
          />
          <LineItem
            label="Hedging Costs"
            value={data.other_income_expense.hedging_costs}
            indent={1}
          />
          <LineItem
            label="Other Income"
            value={data.other_income_expense.other_income}
            indent={1}
          />
          <LineItem
            label="Other Expense"
            value={data.other_income_expense.other_expense}
            indent={1}
          />
          <LineItem
        ...
        <ExpandableSection title="Taxes" sectionKey="taxes">
          <LineItem
            ...
            value={data.taxes.current_tax_expense}
            indent={1}
          />
          <LineItem
            label="Deferred Tax Expense"
            value={data.taxes.deferred_tax_expense}
            indent={1}
          />
          <LineItem
            label="Tax Credits"
            value={-data.taxes.tax_credits}
            indent={1}
          />
          <LineItem

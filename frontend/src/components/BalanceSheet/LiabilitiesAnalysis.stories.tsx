...
import { LiabilitiesAnalysis } from './LiabilitiesAnalysis';

const meta: Meta<typeof LiabilitiesAnalysis> = {
  title: 'Components/LiabilitiesAnalysis',
  component: LiabilitiesAnalysis,
  tags: ['autodocs'],
  parameters: {
    layout: 'padded',
  },

  ...
  useEffect(() => {
    const generateScenarioData = () => {
      ...
      for (let i = 0; i < 12; i++) {
        const month = i + 1;
        const revenue =
          baseRevenue * Math.pow(1 + parameters.growthRate / 100, month / 12);
                  ...
                  <div className="flex items-center gap-4">
                    <Slider
                      ...
                      onValueChange={(value: number[]) =>
                        handleParameterChange('growthRate', value)
                      }
                      className="flex-1"
                    />
                    <Input
                      ...
                      value={parameters.growthRate}
                      onChange={e =>
                        handleParameterChange('growthRate', [
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-4">
                    <Slider
                      ...
                      onValueChange={(value: number[]) =>
                        handleParameterChange('marketingSpend', value)
                      }
                      className="flex-1"
                    />
                    <Input
                      ...
                      value={parameters.marketingSpend}
                      onChange={e =>
                        handleParameterChange('marketingSpend', [
                          Number(e.target.value),
                        ])
                      }
                      className="w-20"
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-4">
                    <Slider
                      ...
                      onValueChange={(value: number[]) =>
                        handleParameterChange('operatingMargin', value)
                      }
                      className="flex-1"
                    />
                    <Input
                      ...
                      value={parameters.operatingMargin}
                      onChange={e =>
                        handleParameterChange('operatingMargin', [
                          Number(e.target.value),
                        ])
                      }
                      className="w-20"
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-4">
                    <Slider
                      ...
                      onValueChange={(value: number[]) =>
                        handleParameterChange('inflationRate', value)
                      }
                      className="flex-1"
                    />
                    <Input
                      ...
                      value={parameters.inflationRate}
                      onChange={e =>
                        handleParameterChange('inflationRate', [
                          Number(e.target.value),
                        ])
                      }
                      className="w-20"
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-4">
                    <Slider
                      ...
                      onValueChange={(value: number[]) =>
                        handleParameterChange('taxRate', value)
                      }
                      className="flex-1"
                    />
                    <Input
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-4">
                    <Slider
                      ...
                      onValueChange={(value: number[]) =>
                        handleParameterChange('discountRate', value)
                      }
                      className="flex-1"
                    />
                    <Input
                      ...
                      value={parameters.discountRate}
                      onChange={e =>
                        handleParameterChange('discountRate', [
                          Number(e.target.value),
                        ])
                      }
                      className="w-20"
